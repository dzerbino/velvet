...
Read IDs are stored on signed 32bit integers, meaning that if you have a big assembly with more than 2.2 Mo reads more memory is needed to track the reads. To do so, simply add the following option to the make command:
