...
\textbf{Note:} A slight discrepancy exists between the binary and non-binary mode of Velvet. If you are running the Columbus module and your reference contains N's, they are simply converted to A's in the binary version, whereas the traditional version masks these gaps.
